        ...
        try:
            if is_ai_available():
                ...
                if parsed:
                    ...
                    article["ai_location"] = parsed.get("location", "")
                    article["ai_victim"] = parsed.get("victim", "")
        ...
        for cve_data in new_cves:
            ...
            if is_ai_available():
                ...
                if parsed:
                    ...
                    cve_data["ai_location"] = parsed.get("location", "")
                    cve_data["ai_victim"] = parsed.get("victim", "")
                else:
